...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_default(
        KC_FN3,    KC_1,     KC_2, KC_3, KC_4, KC_5, KC_6, KC_7,    KC_8,   KC_9,    KC_0, KC_MINS,  KC_EQL, KC_BSPC, 
    ...
    [1] = LAYOUT_default(
        ...
        KC_BTLD, KC_F24,   KC_F16,   KC_F17,  KC_F18,  KC_F19, _______, _______, _______, _______, _______, _______, _______, _______, _______,
