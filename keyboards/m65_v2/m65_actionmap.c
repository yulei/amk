...
const action_t actionmaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_default(
        ...
        AC_TAB,     AC_Q,     AC_W, AC_E, AC_R, AC_T, AC_Y, AC_U,    AC_I,   AC_O,    AC_P, AC_LBRC, AC_RBRC, AC_BSLS, 
    ...
    [1] = LAYOUT_default(
        ...
        AC_BTLD, AC_RGBT, AC_RGBM,  AC_F24, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, 
        _______,  AC_F17,  AC_F18,  AC_F19, _______, _______, AC_LEFT, AC_DOWN,   AC_UP, AC_RGHT, _______, _______, _______, _______, 
