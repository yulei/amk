...
GC_KEYMAPS = {
	...
	[1]=LAYOUT_default(
		...
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
		_______,  GC_FN3,  GC_FN4, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
		GC_BTLD, _______, _______, _______, _______, _______, GC_LEFT, GC_DOWN,   GC_UP, GC_RGHT, _______, _______,          _______, _______, _______,
	...
	[2]=LAYOUT_default(
		...
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
		_______, _______, _______,                            _______,                            GC_FN1, _______,          _______, _______, _______),
};
#endif
