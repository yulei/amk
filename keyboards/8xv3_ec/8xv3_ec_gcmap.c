...
const action_t fn_actions[] = {
	...
	[5] = ACTION_LAYER_TAP_KEY(1, KC_SPC),
};
#else
...
#define GC_FN5 	ACTION_LAYER_TAP_KEY(1, KC_SPC)
#endif
...
GC_KEYMAPS = {
	[0]=LAYOUT_default(
		...
		GC_CAPS,  GC_A, GC_S, GC_D, GC_F, GC_G, GC_H, GC_J, GC_K, GC_L, GC_SCLN, GC_QUOT, GC_BSLS, GC_ENT,  GC_ENT,
		GC_LSFT, GC_LGUI, GC_Z, GC_X, GC_C, GC_V, GC_B, GC_N, GC_M, GC_COMM, GC_DOT, GC_SLSH,     GC_RSFT,            GC_UP,
	...
	[1]=LAYOUT_default(
		...
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   GC_VOLU,
