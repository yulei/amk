...
GC_KEYMAPS = {
	[0]=LAYOUT_default(
		GC_ESC, GC_F1, GC_F2, GC_F3, GC_F4, GC_F5, GC_F6, GC_F7, GC_F8, GC_F9, GC_F10, GC_F15, GC_F12,   GC_PSCR, GC_SLCK, GC_FN0,
		...
		GC_LCTL, GC_LGUI, GC_LALT,                 GC_FN5,                     GC_RALT,GC_FN1,GC_RCTL,  GC_LEFT, GC_DOWN, GC_RGHT),
