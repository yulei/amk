...
GC_KEYMAPS = {
	[0]=LAYOUT_default(
		GC_ESC, GC_F1, GC_F2, GC_F3, GC_F4, GC_F5, GC_F6, GC_F7, GC_F8, GC_F9, GC_F10, GC_F11, GC_F24,   GC_PSCR, GC_SLCK, GC_FN0,
		...
		GC_CAPS,  GC_A, GC_S, GC_D, GC_F, GC_G, GC_H, GC_J, GC_K, GC_L, GC_SCLN, GC_QUOT,      GC_ENT,
