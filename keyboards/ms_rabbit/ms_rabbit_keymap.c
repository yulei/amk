...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0]=LAYOUT_default(
        ...
        KC_LCTL, KC_LGUI,  KC_LALT,                 LT(1,KC_SPC),                                    KC_RALT, KC_RGUI, KC_RCTL),
    [1]=LAYOUT_default(
        _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12, _______, KC_PSCR,
        QK_BOOT,   RGB_TOG, RGB_MOD,  KC_F13, _______, _______, _______, _______, _______, _______, _______, _______, _______,  KC_DEL,
        _______, KC_VOLU, KC_VOLD, KC_CALC, _______, _______, KC_LEFT, KC_DOWN,   KC_UP,KC_RIGHT, _______, _______,          _______,
