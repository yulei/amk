...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1]=LAYOUT_default(
		...
		_______,  KC_FN1, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______,
		KC_BTLD, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
		_______,           KC_F21,  KC_F22,  KC_F23,  KC_F24, _______, _______, _______, _______, _______, _______,          _______,                   KC_VOLU,
