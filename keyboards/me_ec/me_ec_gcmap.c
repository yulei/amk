...
GC_KEYMAPS = {
	[0]=LAYOUT_default(
		...
		GC_LCTL, GC_LGUI, GC_LALT,                 GC_FN1,                    GC_RALT,GC_RGUI,GC_RCTL,  GC_LEFT, GC_DOWN, GC_RGHT),

	[1]=LAYOUT_default(
		GC_MUTE,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______,
