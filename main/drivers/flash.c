...
#   include "flash_nrf52.c"
    ...
    || defined(STM32F722xx) || defined(STM32L072xx) \
    || defined(STM32F401xC) || defined(STM32F446xx) \
    || defined(STM32G431xx) || defined(STM32L432xx) \
    || defined(STM32F412Rx) || defined(STM32L476xx)
