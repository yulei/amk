...
static const keycode_map_t keycode_map[] = {
    ...
    {.vial_keycode= KC_LSPO,            .amk_keycode = ACTION_FUNCTION(AF_KC_LSPO)},
    {.vial_keycode= KC_RSPC,            .amk_keycode = ACTION_FUNCTION(AF_KC_RSPC)},
    {.vial_keycode= KC_LCPO,            .amk_keycode = ACTION_FUNCTION(AF_KC_LCPO)},
    {.vial_keycode= KC_RCPC,            .amk_keycode = ACTION_FUNCTION(AF_KC_RCPC)},
    {.vial_keycode= KC_LAPO,            .amk_keycode = ACTION_FUNCTION(AF_KC_LAPO)},
    {.vial_keycode= KC_RAPC,            .amk_keycode = ACTION_FUNCTION(AF_KC_RAPC)},
