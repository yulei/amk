...
set(THREADX_DIR ${CMAKE_CURRENT_LIST_DIR}/rtos/threadx)
...
target_compile_definitions(${KEYBOARD} PUBLIC "TX_INCLUDE_USER_DEFINE_FILE")

# ports
target_include_directories(${KEYBOARD}
    PUBLIC
    ${THREADX_DIR}/ports/cortex_${MCU_ARCH}/gnu/inc
)

target_sources(${KEYBOARD}
    PRIVATE
    ${THREADX_DIR}/ports/cortex_${MCU_ARCH}/gnu/src/tx_thread_context_restore.S
    ${THREADX_DIR}/ports/cortex_${MCU_ARCH}/gnu/src/tx_thread_context_save.S
    ${THREADX_DIR}/ports/cortex_${MCU_ARCH}/gnu/src/tx_thread_interrupt_control.S
    ${THREADX_DIR}/ports/cortex_${MCU_ARCH}/gnu/src/tx_thread_interrupt_disable.S
    ${THREADX_DIR}/ports/cortex_${MCU_ARCH}/gnu/src/tx_thread_interrupt_restore.S
    ${THREADX_DIR}/ports/cortex_${MCU_ARCH}/gnu/src/tx_thread_schedule.S
    ${THREADX_DIR}/ports/cortex_${MCU_ARCH}/gnu/src/tx_thread_stack_build.S
    ${THREADX_DIR}/ports/cortex_${MCU_ARCH}/gnu/src/tx_thread_system_return.S
    ${THREADX_DIR}/ports/cortex_${MCU_ARCH}/gnu/src/tx_timer_interrupt.S
)
